...
namespace BillTrackerClient.App.DataModels
{
    public partial class BillTrackerContext : DbContext
    {
        ...
        public virtual DbSet<Vwerror> Vwerrors { get; set; }
        public virtual DbSet<Vwloan> Vwloans { get; set; }
        public virtual DbSet<Vwmiscellaneou> Vwmiscellaneous { get; set; }
        public virtual DbSet<Vwpost> Vwposts { get; set; }
        public virtual DbSet<Vwreply> Vwreplies { get; set; }
        public virtual DbSet<Vwsubscription> Vwsubscriptions { get; set; }
        public virtual DbSet<Vwsuggestion> Vwsuggestions { get; set; }
        public virtual DbSet<Vwuser> Vwusers { get; set; }
        public virtual DbSet<Watingoption> Watingoptions { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Suggestion>(entity =>
            {
                ...
                entity.Property(e => e.SuggestBody)
                    .IsRequired()
                    .HasColumnType("text");

                entity.Property(e => e.SuggestHeader)
                    .IsRequired()
                    .HasMaxLength(255);
            ...
            modelBuilder.Entity<Watingoption>(entity =>
            {
                ...
                entity.Property(e => e.WaitingOption)
                    .IsRequired()
                    .HasMaxLength(255);
            });
