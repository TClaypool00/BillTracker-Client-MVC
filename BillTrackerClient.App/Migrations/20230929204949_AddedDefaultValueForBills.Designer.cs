...
namespace BillTrackerClient.App.Migrations
{
    ...
    [Migration("20230929204949_AddedDefaultValueForBills")]
    partial class AddedDefaultValueForBills
    {
            ...
            modelBuilder.Entity("BillTrackerClient.App.DataModels.PaymentHistory", b =>
                {
                    ...
                    b.HasOne("BillTrackerClient.App.DataModels.Loan", "Loan")
                        .WithMany("PaymentHistories")
                        .HasForeignKey("LoanId");

                    b.HasOne("BillTrackerClient.App.DataModels.Subscription", "Subscription")
                        .WithMany("PaymentHistories")
